...
class Pruner:
    ...
    def get_pruned_graph(self):
        ...
        # Get all nodes that we can prune their output channels
        sections_input_nodes = self.float_graph.get_pruning_sections_input_nodes(self.fw_info, self.fw_impl)
        ...
        # Compute the mask by the remaining memory left and the
