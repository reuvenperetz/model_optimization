...
if found_tf:
    from model_compression_toolkit.hardware_models.keras_hardware_model.keras_imx500 import KERAS_IMX500_MODEL
    from model_compression_toolkit.hardware_models.keras_hardware_model.keras_tflite import KERAS_TFLITE_MODEL

    tf_models_dict = {'imx500': KERAS_IMX500_MODEL,
                      'tflite': KERAS_TFLITE_MODEL}
if found_torch:
    from model_compression_toolkit.hardware_models.pytorch_hardware_model.pytorch_imx500 import PYTORCH_IMX500_MODEL
    from model_compression_toolkit.hardware_models.pytorch_hardware_model.pytorch_qnnpack import PYTORCH_QNNPACK_MODEL

    torch_models_dict = {'imx500': PYTORCH_IMX500_MODEL,
