import model_compression_toolkit.common.hardware_model as hw_model
...
def get_tflite_hw_model():
    ...
    eight_bits = hw_model.OpQuantizationConfig(
        activation_quantization_method=model_compression_toolkit.common.framework_hardware_spec.hardware_definition
            .quantization.quantization_config.QuantizationMethod.UNIFORM,
        weights_quantization_method=model_compression_toolkit.common.framework_hardware_spec.hardware_definition
            .quantization.quantization_config.QuantizationMethod.SYMMETRIC,
        activation_n_bits=8,
        weights_n_bits=8,
...
# Fusing patterns: https://github.com/tensorflow/tensorflow/blob/master/tensorflow/core/grappler/optimizers/remapper.cc#L43
