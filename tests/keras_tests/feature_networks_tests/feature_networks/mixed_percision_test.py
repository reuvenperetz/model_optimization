...
class MixedPercisionManuallyConfiguredTest(MixedPercisionBaseTest):
    ...
    def get_quantization_config(self):
        qc = mct.QuantizationConfig(mct.QuantizationErrorMethod.MSE, mct.QuantizationErrorMethod.MSE,
                                    model_compression_toolkit.hardware_model.op_quantization_config.QuantizationMethod.POWER_OF_TWO, model_compression_toolkit.hardware_model.op_quantization_config.QuantizationMethod.POWER_OF_TWO,
