...
from model_compression_toolkit.tpc_models.keras_tp_models.keras_default import generate_keras_tpc
...
class MixedPercisionManuallyConfiguredTest(MixedPercisionBaseTest):
    ...
    def get_fw_hw_model(self):
        ...
        return generate_keras_tpc(name="mp_test", tp_model=mp_hw_model)
    ...
    def get_fw_hw_model(self):
        ...
        mp_hw_model = generate_mixed_precision_test_hw_model(base_cfg=base_config,
                                                             mp_bitwidth_candidates_list=[(8, 16), (2, 16), (4, 16),
                                                                                          (16, 16)])
        return generate_keras_tpc(name="mp_dw_test", tp_model=mp_hw_model)
...
class MixedPrecisionActivationDisabled(MixedPercisionBaseTest):
    ...
    def get_fw_hw_model(self):
        ...
        return generate_keras_tpc(name="mp_weights_only_test", tp_model=mp_hw_model)
